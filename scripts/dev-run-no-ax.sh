...
#
# This is for high-frequency UI testing. It intentionally
...
# runs for non-AX badge/status data, and panel/capture hotkeys stay available.
#
# Usage:
...
NARC_SIGNING_MODE=adhoc bash "${SCRIPT_DIR}/build-app.sh" "${BUILD_CONFIG}"
...
echo "   AX-dependent features disabled; Assistant / panel UI remain available."
